...
public class HtmlUnitExample {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println( body.asXml().substring(0, 50) );
        ...
        DomNodeList<DomNode> data = results.querySelectorAll(".in-header");
        System.out.println("Number od query results: " + data.size());
